...
# ============================================
# Digital Gateway Platform - Custom Gems
# ============================================
...
# Security
gem "lockbox"          # Encrypt sensitive data (BYOK API Keys)
...
gem "gemini-ai", "~> 4.0"          # Google Gemini API

# Utilities
gem "aasm"             # State machine (MVT workflow, Order status)
